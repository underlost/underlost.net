    ...
    <div id="page" className={`${bodyClass} ${className} ${theme === `dark` ? `dark` : `light`} ${accessible === true ? `accessible-mode` : ``} ${menuState}`}>
      ...
      <div className="fixed bottom-8 right-8 z-30">
        <Link className="btn btn-subscribe" href="/membership">
          <span>
            <svg className="h-6 w-6" width="100pt" height="100pt" version="1.1" fill="currentColor" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="site-copyright text-xs py-5 px-10 relative">
          <div className="relative z-10">
            <p className="text-balance">
              <Link href="/">{site.title}</Link> Copyright © Tyler Rilling 2001 - 2025. Published with Ghost. <br /> View{` `}
