...
const MetalostBlock = () => {
  console.log(`MetalostBlock`)

  return (
    <div className="grid grid-cols-12 gap-0 mt-20 lg:mt-5 mb-20">
      <div className="col-span-12 lg:col-span-6 relative flex order-2 lg:order-1">
        <div className="z-30 text-white mt-auto pb-12 w-full pt-16 lg:pt-0">
