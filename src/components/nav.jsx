      ...
      <nav className={"site-nav"}>
        <ul className={"sections-nav list-unstyled text-left pt-3 pt-md-5 pb-md-5"}>
          ...
          <li className={"about-url menu-item"}>
            <Link className={"site-nav-about"} to="/about/">About</Link>
          </li>
          <li className={"portfolio-url menu-item"}>
            <Link className={"site-nav-portfolio"} to="/portfolio/">Selected Works</Link>
          </li>
          <li className={"contact-url menu-item"}>
            <Link className={"site-nav-contact"} to="/contact/">Contact</Link>
          </li>
        </ul>
      </nav>
    </div>
