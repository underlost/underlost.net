...
/**
 *
 * Boredable landing page
 *
 */
const BoredablePage = ({ location }) => {
  const data = {
    ghostPage: {
      codeinjection_styles: {},
      title: `Boredable`,
      html: `<p>Post something.</p>`,
      feature_image: ``,
    },
  }

  return (
    <Layout className="boredable-layout">
      ...
      <div className="pt-11">
        ...
        <div className="text-base max-w-6xl mx-auto mb-8 lg:mb-20 px-8 lg:px-0">
          <div className="lg:columns-3 text-left lg:gap-12 lg:text-sm leading-relaxed mb-16">
            ...
            <p className="mb-5 break-before-all break-inside-avoid-column">
              But, thats kind of the issue with startup culture and building something that turns into something big, isn&apos;t it? It becomes so large it needs to do everything in order
              to grow its user base to continue to meet investors&apos; expectations. It&apos;s only successful if the profits continue to grow. It&apos;s frustrating how after reaching
              that level of success, so many websites and services will turn their back on their users. While growth is natural, a website shouldn&apos;t be beholden to it&apos;s
              stakeholders. And a change in rules or policies shouldn&apos;t alienate the users that helped build your community.
            </p>
        ...
        <div className="bg-[#cdd422] text-black py-16 lg:py-28">
        ...
        <div className="py-16 lg:py-28">
          <div className="mx-auto max-w-lg text-left px-8 lg:px-0">
            <div className="mx-auto text-base">
              <h2 className="text-3xl font-black mb-2 lg:pr-24">Building Something I want to Use</h2>
              <p className="mb-4">
                ...
                main purpose- to allow you to share whats on your mind at the moment, or what you&apos;re up to in fun and creative ways. Boredable would be a platform to post whatever you
                want, in whatever way you want. Just with out the nazis and crypto bros.
              </p>

              <p>
                It has the people you follow front and center, with the ability to discover content based on what you like, or where you are. A social media platform shouldn&apos;t be used
                for banking. It also doesn&apos;t need to be powered by AI. It simply doesn&apos;t need to be an everything app. I know how I want to connect with others already.
            ...
            <div className="grid grid-cols-12 lg:gap-24">
              <div className="col-span-12 lg:col-span-5 order-1 lg:order-2">
                <div className="aspect-square mb-4 relative shadow-lg border border-black rounded overflow-hidden">
                  <StaticImage
                    src="../../static/images/boredable/screenshots/feature_profile.jpg"
            ...
            <div className="grid grid-cols-12 lg:gap-24">
              <div className="col-span-12 lg:col-span-5 order-1 lg:order-1">
                <div className="bg-zinc-900 aspect-square mb-4 relative shadow-lg border border-black rounded overflow-hidden">
                  <StaticImage
                    src="../../static/images/boredable/screenshots/feature_posts.jpg"
                    alt="Image of a map with locations"
                    className="w-full h-full absolute inset-0 object-cover rounded"
                  />
                </div>
              ...
              <div className="col-span-12 lg:col-span-7 flex order-2 lg:order-2">
                <div className="lg:my-auto lg:pr-16">
                  ...
                  <p className="text-md">
                    Remember the days of LiveJournal or Myspace where you could share how you were feeling and what you were doing? While images and short text are the focus of a post, you
                    can include a number of optional pieces of metadata, like location, what you’re listening to and how you’re feeling, with styling powered by markdown. Want to add more
                    flare to the post? Set a custom theme (and even css) for each post to make it stand out. Don’t feel like seeing a chaotic rainbow of a timeline? Don’t worry, users can
                    also turn off styling.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto mb-16 text-left px-8 lg:px-0">
            <div className="grid grid-cols-12 lg:gap-24">
              <div className="col-span-12 lg:col-span-5 order-1 lg:order-2">
                <div className="bg-zinc-900 aspect-square mb-4 relative shadow-lg border border-black rounded overflow-hidden">
                  <StaticImage
                    src="../../static/images/boredable/screenshots/map_places.jpg"
                    alt="Image of a map with locations"
                    className="w-full h-full absolute inset-0 object-cover rounded"
                  />
                </div>
              ...
              <div className="col-span-12 lg:col-span-7 flex order-2 lg:order-1">
                <div className="lg:my-auto lg:pl-16">
                  ...
                  <p className="text-md">
                    Want to see what people are posting near you? Or maybe you’re interested in seeing content happening in an area you’re planning to travel to? Set your location anywhere
                    in the world, and see what’s happening in that area. Not only that, with custom maps, you can also keep track of places you might want to go, where you’ve been, or any
                    other type of dataset you want!
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-purple text-white py-16 lg:py-28 px-8 lg:px-0">
          <div className="max-w-2xl mx-auto text-orange">
          ...
          <div className="max-w-2xl mx-auto text-base">
            <p className="mb-4">
              ...
              commitment to a user-first mindset. Boredable would be a deviation of mainstream platforms, carving out piece of internet where genuine connections are made and users are the
              real focus. How could this be achieved? It might look a little something like this:
            </p>
            <ol className="mb-5 list-decimal pl-5 space-y-4">
              ...
              <li className="mb-2">
                <strong>Sustained Revenue Cycle</strong>: As more users recognize and appreciate the value of the platform&apos;s premium offerings, the revenue generated would continue to
                be reinvested in development. This would create a sustainable cycle of growth and innovation, with users always at the heart of decisions.
              </li>
            </ol>

            <p>
              Of course this is just the start. To be sustainable, I’d also love to partner with sponsors and organizations to keep Boredable as free as possible for all users, while also
        ...
        <div className="text-xl max-w-2xl mx-auto py-16 lg:py-28 px-8 lg:px-0">
          ...
          <div className="text-left text-base lg:pb-16 leading-relaxed">
            <p className="mb-4">
              I spent the last year (give or take) building this idea from scratch, and refining the idea. The entire platform is actually already built, and the code will be up on Github
              soon. Everything from authentication, the API, basic profiles, filtering, blocking, geotagging, all the core features I wanted are built out and mostly working! But it’s not
              great- there&apos;s a lot of bugs, the UX is still a work in progress, and Im working on scaling. It&apos;s little more than a minimum viable product right now. That is to
              say, it works, but its not ready to compete with the likes of Threads or BlueSky or other shiny new platforms that are competeing for Twitter&apos;s spot.
            </p>

            <p>
              Thats where you come in. Right now I am mainly wanting to gauge interest and support in the project. If you are interested in donating or becoming a sponsor for the project,
              please also reach out! If you&apos;re interested in getting involved or just want to know more, let&apos;s chat. I&apos;m{` `}
